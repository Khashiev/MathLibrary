...
START_TEST(fabs_test2) { ck_assert_ldouble_eq(s21_fabs(-1.5), fabs(-1.5)); }
END_TEST
...
START_TEST(fabs_test8) { ck_assert_ldouble_eq(s21_fabs(124.58), fabs(124.58)); }
END_TEST

START_TEST(fabs_test9) {
  ck_assert_ldouble_eq(s21_fabs(-124.58), fabs(-124.58));
}
END_TEST
